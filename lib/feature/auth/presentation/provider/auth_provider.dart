...
import 'package:blindside/app/shared/flushbar_notification.dart';
import 'package:blindside/app/view/view_model/base_view_model.dart';
import 'package:blindside/core/errors/failure.dart';
import 'package:blindside/core/injections/injections.dart';
import 'package:blindside/core/local_data/local_data_storage.dart';
import 'package:blindside/core/navigators/navigators.dart';
import 'package:blindside/feature/auth/data/model/user_model.dart';
import 'package:blindside/feature/auth/domain/usecases/login_usecase.dart';
import 'package:blindside/feature/auth/domain/usecases/register_usecase.dart';
  ...
  Future<bool> authenticateWithBiometry(BuildContext context) async {
    ...
    try {
      authenticated = await biometryAuth.authenticate(
        localizedReason: 'blindside biometric login',
        biometricOnly: true,
        stickyAuth: true,
      );
